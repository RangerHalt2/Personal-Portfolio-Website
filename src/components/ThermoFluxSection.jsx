        ...
        <div className="grid grid-cols-1 items-center md:grid-cols-2">
          ...
          <div className="mt-6 md:mt-0">
            ...
            <p className="text-muted-foreground text-left mt-3 p-6">
              Our Team developed ThermoFlux to be a 5 minute 3D platforming
              game. I worked with the team enabling them to use GitHub,
              supporting Tech's write scripts, and writing core functionality of
              the game.
            </p>
            <p className="text-muted-foreground text-left mt-3 p-6">
